...
def main():
    input_path = os.path.join(os.path.dirname(__file__), "../2021年裁判文书数据1/2021年裁判文书数据/2021年裁判文书数据/2021年01月裁判文书数据.csv")
    output_path = os.path.join(os.path.dirname(__file__), "./输出结果/2021年01月裁判文书数据.csv")
